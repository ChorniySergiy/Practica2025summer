...
class Config {
  ...
  private static $default = [
    ...
    'cache_key' => 0,
    'storage_path' => '_files',
    'files_exclude' => '/\.(php|html|json|js|css|htaccess|htpasswd)$/i', // excludes all files that end with .pdf, .jpeg and .jpg / case insensitive
    'dirs_exclude' => '',
    'allow_symlinks' => true,
    'get_mime_type' => false,
    'license_key' => '',
    ...
    'allow_tasks' => false,
    'demo_mode' => false,
    'upload_allowed_file_types' => 'image/*',//  image/* - all image type
